...
while True:
    ...
    message = {
        ...
        "throughput": random.normalvariate(
            config.get("meanThroughput"), config.get("stdevThroughput")
        ),
        "temperature": random.normalvariate(
            config.get("meanTemperature"), config.get("stdevTemperature")
        ),
